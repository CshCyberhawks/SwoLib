...
class AutoPathManager(swerveAuto: SwerveAuto, gyro: GenericGyro, val commandsToRun: HashMap<String, HashMap<Int, Pair<CommandBase, AttachedCommandType>>> = HashMap()) {
