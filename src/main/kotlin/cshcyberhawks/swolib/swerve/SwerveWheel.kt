...
class SwerveWheel(var turnMotor: TalonSRX, var driveMotor: WPI_TalonFX, var turnEncoder: AnalogTurnEncoder, var drivePIDF: Number, var drivePID: PIDController, var turnPID: PIDController, val wheelRadius: Number, val gearRatio: Number, val maxSpeed: Number) {
    ...
    fun drive(inputSpeed: Number, inputAngle: Number) {
        ...
        driveMotor.set(ControlMode.PercentOutput, MathUtil.clamp(speed / maxSpeed.toDouble(), -1.0, 1.0))
